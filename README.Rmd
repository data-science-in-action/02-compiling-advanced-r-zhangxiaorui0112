...
First, download *Rtools* to your computer, preferably in disk C, and select "Add Rtools to system PATH". Install the package *devtools*, and then input the command: `library(usethis)`, `library(devtools)`, `devtools::install_github(" Hadley /emo")`
